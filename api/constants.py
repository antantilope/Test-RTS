...
SECONDS_TO_START_ENGINE = 7
ACTIVATE_ENGINE_POWER_REQUIREMENT_TOTAL = 18000
...
ENGINE_BATTERY_CHARGE_PER_SECOND = round(ACTIVATE_ENGINE_POWER_REQUIREMENT_PER_SECOND * 2)

SCANNER_SECONDS_TO_START = 4
ACTIVATE_SCANNER_POWER_REQUIREMENT_TOTAL = 3000
ACTIVATE_SCANNER_POWER_REQUIREMENT_PER_SECOND = round(
    ACTIVATE_SCANNER_POWER_REQUIREMENT_TOTAL
    / SCANNER_SECONDS_TO_START
)
SCANNER_POWER_REQUIREMENT_PER_SECOND = 50
...
EBEAM_CHARGE_THERMAL_RATE_PER_SECOND = 5
